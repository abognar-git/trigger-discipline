...
>
> No install, no account, nothing to run. One file, seven shifts, about fifteen
...
You play seven shifts, in the order the job gets harder. The queue starts
...
![The shift select screen: seven shifts, each unlocking the next.](docs/figures/shift_select.png)
